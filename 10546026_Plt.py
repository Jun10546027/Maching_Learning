...
#資料來源
res_max = requests.get('https://www.coingecko.com/price_charts/279/usd/max.json')
jd_max = res_max.json()

res_year = requests.get('https://www.coingecko.com/price_charts/279/usd/custom.json?from=1558774919&to=1559026989')
...
#設定title，y軸，X軸
plt.title("All of Ethereum tendency / month",loc="right")
plt.ylabel('value')
plt.xlabel('time')
...
#設定 title , 設定x軸，Y軸
plt.title("Ethereum tendency of year / week",loc="right")
plt.xlabel('time')
plt.ylabel('value')
plt.show()
